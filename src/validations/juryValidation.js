...
exports.addJuryValidation = (req, res, next) => {
    const { full_name, email, contact_no, password, address, designation, DOB, about, links } = req.body;
...
exports.updateJuryValidation = (req, res, next) => {
    const { jury_id, password, full_name, email, contact_no, address, designation, DOB, about, links, isFirstTimeSignIn } = req.body;
