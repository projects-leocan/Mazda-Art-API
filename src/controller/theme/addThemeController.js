...
exports.addThemeController = async (req, res) => {
  ...
  const query = `INSERT INTO theme (theme, created_at, updated_at, created_by, updated_by) VALUES ('${theme}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, ${admin_id}, ${admin_id}) RETURNING id`;
